package org.example.src.console;
...
public class UI {
    ...
    public void callThreeFunctionalities(){
        service.deleteStudent("101");
        service.saveStudent("101", "George", 221);
        service.deleteTema("102");
        service.saveTema("102", "O tema noua", 5, 3);
        service.saveNota("101", "102", 8, 5, "Acceptabil");
    }
